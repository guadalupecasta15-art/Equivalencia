  ...
  return (
    <div style={{display:"flex",alignItems:"center",gap:8}} aria-label="UAG Online">
      <img
        ...
        alt="UAG Online"
        style={{height: size * 1.5, width: "auto", objectFit: "contain", filter: white ? "brightness(0) invert(1)" : "none"}}
      />
    </div>
  );
}
...
function ReportesPage() {
  ...
  const KPIS=[
    ...
    {l:"Tasa de aprobaci�n",v:`${tasaAprobacion}%`,c:T.purple,icon:<Target size={16}/>},
  ];
    ...
    <div className="pw">
      ...
      <div style={{display:"grid",gap:14,gridTemplateColumns:"1fr",marginBottom:14}}>
        <div style={{display:"grid",gap:14,gridTemplateColumns:"1fr"}}>
          <div className="card">
            <div style={{padding:"14px 18px 10px"}}><p className="stitle">Equivalencias por per�odo</p><p style={{fontSize:12,color:T.t3,marginTop:2}}>�ltimos meses con solicitudes</p></div>
            <div className="divider"/>
            <div style={{padding:"12px 8px"}}>
              {monthlyData.length===0?(
                <ES icon={<BarChart2 size={36}/>} title="Sin datos a�n" desc="Todav�a no hay suficientes equivalencias con fecha de solicitud para graficar."/>
              ):(
      ...
      <div className="card">
        ...
        <div className="divider"/>
        <ES icon={<UserCog size={36}/>} title="Sin datos suficientes" desc="Todav�a no se registra qu� Success Coach atiende a cada alumno o equivalencia en la base de datos. Para activar este reporte hay que agregar esa relaci�n."/>
      </div>
    </div>
  );
}
